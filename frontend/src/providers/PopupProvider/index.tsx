	...
	return (
		<>
			{isOpenPopup && popupOptions?.eventId && (
				<Popup x={popupOptions.x} y={popupOptions.y} eventId={popupOptions.eventId} />
			)}
			{isOpenPopup && popupOptions?.calendarId && (
				<CalendarPopup x={popupOptions.x} y={popupOptions.y} calendarId={popupOptions.calendarId} />
			)}
			{children}
		</>
	);
