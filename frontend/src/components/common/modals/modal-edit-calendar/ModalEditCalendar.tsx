...
const ModalEditCalendar: FC<IModalEditCalendarProps> = ({ calendarData, calendarId }) => {
			...
			{participants.map((participant) => (
				...
				>
					...
					<select
						...
						onChange={(e) =>
							handlePermissionChange(participant.user_id, e.target.value as CategoryPermission)
						}
					...
					<div className="form-group">
						...
						<UserMultiSelector
							...
							defaultSelectedUsers={
								calendarData.participants.map((participant) => participant.id).length > 0
