...
const DatePicker: FC<DatePickerProps> = ({ selectDate, selectedDate, error, locale = 'default' }) => {
	...
	return (
		<div className={styles.date__picker__container} style={stylesPicker} ref={miniCalendarRef}>
			<DateInput
				dateValue={dateValue}
				locale={locale}
