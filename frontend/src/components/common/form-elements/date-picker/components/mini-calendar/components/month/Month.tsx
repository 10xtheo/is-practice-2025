...
const Month: FC<MonthProps> = ({ monthesName, selectedYear, selectedMonth, setSelectedMonthByIndex, setMode }) => {
	const d = new Date();
	const isCurrentMonth = d.getMonth() === monthesName.monthIndex && selectedYear === d.getFullYear();

	const isSelectedMonth =
		monthesName.monthIndex === selectedMonth.monthIndex && selectedYear === monthesName.date.getFullYear();
