...
const addParticipant = (calendarId: string, participant: IServerUserCategoryParticipant) => requestCalendarParticipants.post<IServerUserCategoryParticipant>(`/${calendarId}/participants`, participant);

const deleteParticipant = (calendarId: string, userId: string) => requestCalendarParticipants.delete<unknown>(`/${calendarId}/participants/${userId}`);
