...
export type RequestsOptionsEvents =
	| GetRequestOptions
	| PostRequestOptionsEvents
	| PostRequestOptionsEventsTimeManagement
	| DeleteRequestOptions
	| PutRequestOptionsEvents
	| PatchRequestOptionsEvents;
...
export type RequestsOptionsEventParticipants =
	| PutRequestOptionsEventParticipants
	| PostRequestOptionsEventParticipants
	| DeleteRequestOptions;
...
interface PutRequestOptionsCalendarParticipants extends BaseRequestOptions<METHODS.PUT> {
	body?: Omit<IServerUserCategoryParticipant, 'user_id'>;
}

export type RequestsOptionsCalendarParticipants =
	| PutRequestOptionsCalendarParticipants
	| PostRequestOptionsCalendarParticipants
	| DeleteRequestOptions;
...
export type RequestsOptionsCalendars =
	| GetRequestOptions
	| PostRequestOptionsCalendars
	| DeleteRequestOptions
	| PutRequestOptionsCalendars
	| PatchRequestOptionsCalendars;
