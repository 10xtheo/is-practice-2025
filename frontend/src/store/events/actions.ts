...
export const createEvent = createAsyncThunk<IEvent, IEventCreate>('events/create-event', async (newEvent, thunkAPI) => {
	try {
...
export const deleteEvent = createAsyncThunk<{ eventId: string }, string>(
	'events/delete-event',
...
export const addEventParticipant = createAsyncThunk<string, { eventId: string; participant: IServerUserParticipant }>(
...
export const deleteEventParticipant = createAsyncThunk<string, { eventId: string; userId: string }>(
...
>('events/find-available-time-slots', async (params, thunkAPI) => {
	try {
...
export const getEventMessages = createAsyncThunk<{ data: IChatMessage[]; count: number }, string>(
...
export const getEventFiles = createAsyncThunk('events/getEventFiles', async (eventId: string) => {
